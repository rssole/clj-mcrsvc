(defproject clj-mcrsvc "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "clj-mcrsvc.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.0"]]}
             :uberjar {:aot [clj-mcrsvc.server]}}
  :main ^{:skip-aot true} clj-mcrsvc.server)
